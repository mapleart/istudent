...
class ModuleUser_EntityUser extends EntityORM
{
    ...
    protected $aRelations = array(
        ...
        'group' => array(self::RELATION_TYPE_BELONGS_TO, 'ModuleGroup_EntityGroup', 'group_id'),
    );
    ...
    {
        return htmlspecialchars($this->getLastName().' '.$this->getFirstName());
    }
    ...
    public function isTutor(){
        return $this->Group_GetGroupByTutorId($this->getId());
    }
}