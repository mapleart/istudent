...
// Модуль Security
$config['module']['security']['hash']  = "student_key"; // "примесь" к строке, хешируемой в качестве security-кода
...
$config['db']['table']['maps_map'] = '___db.table.prefix___maps';
$config['db']['table']['institut'] = '___db.table.prefix___instituts';


$config['db']['table']['notification'] = '___db.table.prefix___notification';
...
$config['db']['table']['document_document'] = '___db.table.prefix___document';
$config['db']['table']['document_document_value'] = '___db.table.prefix___document_value';
$config['db']['table']['document_document_scheme'] = '___db.table.prefix___document_scheme';
$config['db']['table']['document_document_scheme_field'] = '___db.table.prefix___document_scheme_field';
$config['db']['table']['document_document_scheme_field_value'] = '___db.table.prefix___document_scheme_value';
...
$config['router']['page']['sport']         = 'ActionSport';
$config['router']['page']['culture']         = 'ActionCulture';
$config['router']['page']['education']         = 'ActionEducation';
$config['router']['page']['notification']         = 'ActionNotification';
...
$config['components'] = array(
	// Базовые компоненты
	 'ls-vendor', 'ls-core', 'ls-component',   'alert', 'dropdown', 'button', 'block',
	'nav', 'tooltip', 'tabs', 'modal', 'uploader', 'email', 'field', 'pagination', 'editor', 'more',
	'performance', 'actionbar', 'badge', 'autocomplete', 'icon', 'item', 'highlighter','notification', 'blankslate',
